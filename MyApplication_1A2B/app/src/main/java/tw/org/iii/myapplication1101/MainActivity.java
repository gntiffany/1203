package tw.org.iii.myapplication1101;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView log;   // = findViewById(R.id.log);
    private int counter;
